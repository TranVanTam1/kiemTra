...
<div id="NavDrawer" class="drawer drawer--right">
  ...
  <!-- begin mobile-nav -->
  <ul id="menu-menu-chinh" class="mobile-nav"><li  id="menu-item-19"  class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home mobile-nav__item menu-item-19" ><a class="mobile-nav__link" href="/">Trang chủ</a></li><li  id="menu-item-130"  class="menu-item menu-item-type-post_type menu-item-object-page mobile-nav__item menu-item-130" ><a class="mobile-nav__link" href="https://at10.mediawz.com/gioi-thieu/">Giới thiệu</a></li><li  id="menu-item-131"  class="menu-item menu-item-type-post_type menu-item-object-page current_page_parent mobile-nav__item menu-item-131" ><a class="mobile-nav__link" href="#products">Sản phẩm</a></li><li  id="menu-item-133"  class="menu-item menu-item-type-post_type menu-item-object-page mobile-nav__item menu-item-133" ><a class="mobile-nav__link" href="https://at10.mediawz.com/lien-he/">Liên hệ</a></li><li  id="menu-item-134"  class="menu-item menu-item-type-post_type menu-item-object-page mobile-nav__item menu-item-134" ><a class="mobile-nav__link" href="https://at10.mediawz.com/huong-dan-mua-hang/">Hướng dẫn</a></li></ul>  <!-- //mobile-nav --> 
</div>
...
<div class=" mobile-header large--hide">
    <div class="grid">
        <div class="grid__item medium--one-third small--one-half">
            <div class="hd-logo text-left">
               <a href="">
                    <img src="{{ asset('images/'.$tfood->image) }}" alt="AT10 FOOD">
                </a>
            </div>
        </div>
	...
	<div class="breadcrumb-content">
		...
		<div class="wrapper">
			<div class="inner text-center">
				<div class="breadcrumb-big"><h2>{{$tfood->pr_name}}</h2></div>
				<div class="breadcrumb-small">
                	<p id="breadcrumbs"><span><span><a href="http://at10.chonweb.vn/">Trang chủ</a> » <span><a href="http://at10.chonweb.vn/san-pham/">Sản phẩm</a> » <span class="breadcrumb_last" aria-current="page">{{$tfood->pr_name}}</span></span></span></span></p>				</div>
			</div>
		</div>
	</div>
</section>    
...
<div class="wpgs wpgs--with-images images">
	...
	<h1 class="product_title-entry-title">{{$tfood->pr_name}}</h1></div><div class="pro-price clearfix">
	         <span class="current-price"><span class="woocommerce-Price-amount amount">{{$tfood->pr_price_new}}<span class="woocommerce-Price-currencySymbol">&#8363;</span></span></span>
        <span class="original-price"><s><span class="woocommerce-Price-amount amount">{{$tfood->pr_price}}<span class="woocommerce-Price-currencySymbol">&#8363;</span></span></s></span>
...
<div class="product_meta">
	...
	<span class="posted_in">Danh mục: <a href="https://at10.mediawz.com/danh-muc-san-pham/hoa-qua/" rel="tag">{{$tfood->prType->pr_type}}</a>, <a href="https://at10.mediawz.com/danh-muc-san-pham/rau-huu-co/" rel="tag">Rau hữu cơ</a>, <a href="https://at10.mediawz.com/danh-muc-san-pham/thuc-pham-kho/" rel="tag">Thực phẩm khô</a></span>
		...
		<div class="home-section-body">
					<div class="grid-uniform md-mg-left-10 products columns-4">
						...
						@foreach($tfoods as $food)
							@if($food->prType->pr_type==$tfood->prType->pr_type && $food->pr_name!=$tfood->pr_name)
								<div class="md-pd-left10 grid__item large--one-quarter medium--one-third small--one-half">
									<div class="product-item">
										<div class="product-img">
											...
											<img width="260px" height="260px" src="{{ asset('images/'.$food->image) }}" class="attachment-thumb_260x260 size-thumb_260x260 wp-post-image" alt="Cà chua" sizes="100vw" />            </a>
										</div>
										<div class="product-info">
											<div class="product-title">
												<a href="https://at10.mediawz.com/san-pham/ca-chua/">{{$food->pr_name}}</a>
											</div>
											<div class="product-price clearfix">
												<span class="current-price">
													<span class="woocommerce-Price-amount amount">{{$food->pr_price_new}}
